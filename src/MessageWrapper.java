...
public class MessageWrapper {
    ...
    public final Person host;
    public final Person opposite;
    ...
    public String printToHtml() {
        ...
        ArrayList<QEmotion> emotionConfig = new Gson().fromJson(new JsonParser().parse(new JsonReader(new InputStreamReader(Main.class.getResourceAsStream("face_config.json")))).getAsJsonObject().get("sysface").getAsJsonArray(), new TypeToken<List<QEmotion>>() {
        }.getType());
